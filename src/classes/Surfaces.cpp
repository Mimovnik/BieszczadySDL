...
void Surfaces::load() {
    ...
    playerAnimations =
        loadSurfaces("bmp/player", PLAYER_IDLE_ANIM_FRAMES,
                     ...
                     PLAYER_FALL_ANIM_FRAMES, PLAYER_ATTACK1_ANIM_FRAMES, PLAYER_ATTACKUP_ANIM_FRAMES, PLAYER_ATTACKDOWN_ANIM_FRAMES,
    ...
    mobAnimations =
        loadSurfaces("bmp/flyingEye", WRAITH_IDLE_ANIM_FRAMES,
                     ...
                     WRAITH_FALL_ANIM_FRAMES, WRAITH_ATTACK1_ANIM_FRAMES, WRAITH_ATTACKUP_ANIM_FRAMES, WRAITH_ATTACKDOWN_ANIM_FRAMES,
